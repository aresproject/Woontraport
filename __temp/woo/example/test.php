...
try {
	...
	$client = new WC_API_Client( 'http://sandbox2.strachanonline.com', 'ck_c1c9fea015d2da2291331f32d03950ax', 'cs_b2a193a9a1b2c2dae3d248d770efd911', $options );
	...
	//print_r( $client->reports->get_top_sellers( array( 'filter[date_min]' => '2015-07-01' ) ) );
